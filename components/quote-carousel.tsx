...
const testimonials = [
  {
    id: 1,
    quote: "CareerSpark helped me transition from teaching to UX design. The chatbot provided personalized advice and resources that made my career change possible.",
    author: "Jessica Martinez",
    role: "UX Designer at Adobe",
    previousRole: "Elementary School Teacher",
    avatar: "/avatar-woman-1.jpg",
    initials: "JM"
  },
  {
    id: 2,
