      ...
      <section id="success-stories" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <span className="inline-block px-3 py-1 bg-gradient-to-r from-purple-300 to-pink-300 text-white rounded-full text-sm font-medium mb-4">
              Success Stories
            </span>
          ...
          <div className="mt-12 text-center">
            <Button
              variant="outline"
              className="border-purple-400 text-purple-700 hover:bg-purple-50 rounded-full shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
              asChild
            >
              <Link href="/community">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-white text-white hover:bg-pink-500 rounded-full shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
              asChild
            >
              <Link href="/community">
