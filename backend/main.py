...
def get_tavily_tool():
    return TavilySearchResults(
        ...
        exclude_domains=[
            ...
            "linkedin.com/articles/", "linkedin.com/pulse/", "linkedin.com/news/"
        ],
    )
...
MEMORY_TEMPLATE = """You are an AI assistant focused on supporting women in tech. Be empowering, encouraging, and professional.
